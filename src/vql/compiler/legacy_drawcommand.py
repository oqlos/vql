...
def commands_to_program(
    ...
    *,
    ...
    from vql.schema.program import RenderTarget
...
def compile_to_events(program: VQLProgram) -> list["ShapeDrawn"]:
    ...
    """
    from vql.drawing.commands import CommandBus
    from vql.drawing.event_store import EventStore
    from vql.drawing.events import ShapeDrawn
